...
DEFINE_LEVEL("CT", LEVEL_CT, COURSE_CT, ct, generic, 20000, 0x00, 0x00, 0x00, _, sCamCt) 
DEFINE_LEVEL("TSSS", LEVEL_TSSS, COURSE_TSSS, TSSS, generic, 20000, 0x00, 0x00, 0x00, _, sCamTsss) 
DEFINE_LEVEL("BBV", LEVEL_BBV, COURSE_BBV, bbv, generic, 20000, 0x00, 0x00, 0x00, _, sCamBbv) 
