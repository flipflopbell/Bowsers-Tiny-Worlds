...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(1, castle_courtyard_area_1),
		...
		WARP_NODE(0x10, LEVEL_JRB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x11, LEVEL_CCM, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x12, LEVEL_JRB, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x13, LEVEL_CCM, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x14, LEVEL_JRB, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_STAR, -400, 0, -400, 0, 0, 0, (0x10 << 16), bhvWarp),
		OBJECT(MODEL_STAR, -400, 0, -1000, 0, 0, 0, (0x14 << 16), bhvWarp),
		OBJECT(MODEL_STAR, -400, 0, -700, 0, 0, 0, (0x12 << 16), bhvWarp),
		OBJECT(MODEL_STAR, 400, 0, -400, 0, 0, 0, (0x11 << 16), bhvWarp),
