...
const LevelScript level_jrb_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_SNOW_SKYBOX, EDSkyboxSnow_geo), 
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_SNOW_SKYBOX, 0, 0, 0, 0, 0, 0, 0x00000000, bhvCustomSkybox),
		OBJECT(MODEL_NONE, -1337, 0, -269, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -1337, 0, -269),
	...
	AREA(3, jrb_area_3),
		...
		WARP_NODE(0xF0, LEVEL_CASTLE_COURTYARD, 0x01, 0xF0, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_CASTLE_COURTYARD, 0x01, 0xF1, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_SNOW_NIGHT_SKYBOX, 0, 0, 0, 0, 0, 0, 0x00000000, bhvCustomSkybox),
		OBJECT(MODEL_NONE, 0, 0, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 0, 0),
