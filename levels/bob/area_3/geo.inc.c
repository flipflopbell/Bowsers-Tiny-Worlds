...
const GeoLayout bob_area_3_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -2500, -4600, -3500, 90, 0, 50, bob_dl_Skeleton_Dorrie_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bob_area_3[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 20000, 0, 10000, 20000, -100, 10000, geo_camera_main),
				GEO_OPEN_NODE(),
