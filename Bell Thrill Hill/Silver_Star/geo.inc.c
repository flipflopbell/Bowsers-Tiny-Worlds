	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Silver_Star_001_displaylist_mesh_layer_5),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, Silver_Star_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, Silver_Star_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
