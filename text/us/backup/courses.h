COURSE_ACTS(COURSE_BOB, _(" 1 SUPER BELL THRILL"),
       _("GET TO THE GOAL POLE")          , _("CLIMB TO THE TOP OF THE MOUNT") , _("JUMP ON DONUTS FOR 5 SILVER STARS"),
       _("FREE THE JAILED STAR")          , _("SNEAKY AND TRICKY RED COINS")   , _("GREEN DEMON RACE TO THE GOAL POLE"))
